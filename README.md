...
```bash
curl -LO https://github.com/rosscartlidge/ssql/raw/main/ssql_4.23.0_amd64.deb
sudo dpkg -i ssql_4.23.0_amd64.deb
ssql version
```

**GPU-accelerated version (requires NVIDIA CUDA runtime):**
```bash
curl -LO https://github.com/rosscartlidge/ssql/raw/main/ssql-gpu_4.23.0_amd64.deb
sudo dpkg -i ssql-gpu_4.23.0_amd64.deb
ssql version
```
